...
var camera = new THREE.PerspectiveCamera(40, wid/hei, 0.1, 8000);
var renderer = new THREE.WebGLRenderer();
renderer.setSize(wid, hei);
camera.position.set(-622.31, 107.65, -22.73);
camera.rotation.set(-0.959, -1.385, -0.950);
...
function createSurface(){
	...
	soundSurf.position.x = 1000;
	soundSurf.position.y = -200;
